...
caption: #ana sayfa ve /islerim/ grid'inde gorunen bilgiler
  title: Beyaz PVC Yenileme
  subtitle: Erbaa / Fevzi Paşa
  thumbnail: https://i.pinimg.com/originals/f1/64/f5/f164f57d5bb5279b8e937fe1d9ead963.jpg

#proje sayfasinda gorunen bilgiler
title: Erbaa Beyaz PVC Pencere ve Kapı Yenileme
subtitle: Erbaa / Fevzi Paşa
location: "Tokat / Erbaa - Fevzi Paşa Mah."
date: 2026-08-12
...
Erbaa Fevzi Paşa Mahallesi'nde kapsamlı bir tadilat sürecinden geçen bu alanda, eski ve yalıtımsız doğramaların sökülerek yerine modern, ısı yalıtımı yüksek beyaz PVC sistemlerinin montajını tamamladık. 

Mekanın yenilenme aşamasındaki en önemli adımlardan biri olan doğrama montajı, ince işçilik (sıva ve boya) öncesinde kusursuz bir teraziyle kaba inşaata uyarlandı ve duvar işleri için hazır hale getirildi.

### Teknik Detaylar

* **Uzun Ömürlü Beyaz Profil:** Temiz bir görünüm sunan, kolay temizlenebilen ve yıllarca sararma yapmayan 1. sınıf standart beyaz renkli PVC profiller kullanıldı.
* **Üstten Camlı (Vasistaslı) Kapı:** PVC kapının üst kısmına entegre edilen camlı bölme sayesinde, kapı tamamen kapalıyken bile mekanın ekstra gün ışığı alması sağlandı.
