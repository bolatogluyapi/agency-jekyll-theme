...
caption: #ana sayfa ve /islerim/ grid'inde gorunen bilgiler
  title: Çerçevesiz Cam Vitrin
  subtitle: Erbaa / Erek Caddesi
  thumbnail: https://i.pinimg.com/736x/13/ab/0c/13ab0c8e8d6976a9727baae22b7b329e.jpg
...
Erbaa Erek Caddesi üzerinde yer alan bir ticari işletmenin (mağaza/ofis) dış cephesini, müşterileri içeri davet eden modern ve şeffaf bir görünüme kavuşturmak için **Çerçevesiz Cam Vitrin** sistemini uyguladık.

İşletmenin ürünlerini en iyi şekilde sergileyebilmesi ve gün ışığından maksimum faydalanması için alüminyum veya PVC doğrama kullanılmadan tamamen camdan oluşan bir tasarım tercih edildi. **Bolatoğlu Yapı** olarak projelerimizde estetiği ve ticari prestiji her zaman ön planda tutuyoruz.

### Teknik Detaylar

* **10mm Şeffaf Temperli Cam:** Dış cephe güvenliğini sağlamak ve rüzgar yüküne karşı direnç oluşturmak için standart camlara göre çok daha dayanıklı temperli (güvenlik) cam kullanıldı.
* **Zemin Hidrolik (Motorlu) Kapı Sistemi:** Çift kanatlı cam kapılar, zemine gömülen özel hidrolik pompalar sayesinde 90 derece sabitlenebilir ve yavaş kapanır (çarpma yapmaz) şekilde tasarlandı.
